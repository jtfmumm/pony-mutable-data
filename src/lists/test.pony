...
class iso _TestFlatMap is UnitTest
  fun name(): String => "lists/flat_map()"
...
class iso _TestPartition is UnitTest
  fun name(): String => "lists/partition()"
...
//  fun name(): String => "lists/drop_while()"
//
//  fun apply(h: TestHelper) ? =>
//    let a = List[U32]
//    a.push(0).push(1).push(2).push(3).push(4)
...
//
//    h.assert_eq[U64](b.size(), 0)
//    h.assert_eq[U64](c.size(), 1)
//    try h.assert_eq[U32](c(0), 0) else error end
//    h.assert_eq[U64](d.size(), 4)
//    try h.assert_eq[U32](d(0), 1) else error end
//    try h.assert_eq[U32](d(1), 2) else error end
//    try h.assert_eq[U32](d(2), 3) else error end
//    try h.assert_eq[U32](d(3), 4) else error end
//    h.assert_eq[U64](e.size(), 5)
...
//    h.assert_eq[U64](l.size(), 0)
//
//    true

class iso _TestTake is UnitTest
  fun name(): String => "lists/take()"
...
class iso _TestTakeWhile is UnitTest
  fun name(): String => "lists/take_while()"
...
class iso _TestContains is UnitTest
  fun name(): String => "lists/contains()"
...
class iso _TestReverse is UnitTest
  fun name(): String => "lists/reverse()"
